...
module biriscv_multiplier_efficient_3
(
    input           clk_i,
    input           rst_i,
...
wire inst_mule3_w = ((opcode_opcode_i & `INST_MULE3_MASK) == `INST_MULE3);
wire seed_valid_w = opcode_valid_i && inst_mule3_w;
