...
module biriscv_multiplier_efficient_5_n
(
    input           clk_i,
    input           rst_i,
...
localparam [2:0] MULE5N_STATE_IDLE  = 3'd0;
localparam [2:0] MULE5N_STATE_CALC0 = 3'd1;
localparam [2:0] MULE5N_STATE_CALC1 = 3'd2;
localparam [2:0] MULE5N_STATE_CALC2 = 3'd3;
localparam [2:0] MULE5N_STATE_CALC3 = 3'd4;
localparam [2:0] MULE5N_STATE_CALC4 = 3'd5;
...
wire inst_mule5n_w = ((opcode_opcode_i & `INST_MULE5N_MASK) == `INST_MULE5N);
wire seed_valid_w = opcode_valid_i && inst_mule5n_w;
...
wire       calc0_active_w   = (state_q == MULE5N_STATE_CALC0);
wire       calc1_active_w   = (state_q == MULE5N_STATE_CALC1);
wire       calc2_active_w   = (state_q == MULE5N_STATE_CALC2);
wire       calc3_active_w   = (state_q == MULE5N_STATE_CALC3);
wire       calc4_active_w   = (state_q == MULE5N_STATE_CALC4);
