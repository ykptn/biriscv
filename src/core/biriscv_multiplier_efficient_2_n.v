...
module biriscv_multiplier_efficient_2_n
(
    // Inputs
     input           clk_i
    ,input           rst_i
...
wire inst_mule2n_w = ((opcode_opcode_i & `INST_MULE2N_MASK) == `INST_MULE2N);
wire seed_valid_w = opcode_valid_i && inst_mule2n_w;
