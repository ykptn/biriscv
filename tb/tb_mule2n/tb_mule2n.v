...
always @(posedge clk) begin
    if (rst) begin
        ...
        if (!wb_collision_seen &&
            u_dut.writeback_mule2n_valid_w &&
            ...
            $display("[Cycle %0d] MULE2N WB COLLISION: custom rd=%0d value=%0d, pipe0 rd=%0d value=%0d",
                     cycle_count,
                     u_dut.writeback_mule2n_rd_idx_w,
                     u_dut.writeback_mule2n_value_w,
        ...
        if (mem_i_pc_w != last_pc) begin
            ...
            if (mem_i_pc_w == PASS_PC && !pass_reported) begin
                if ((reg_r12_w == reg_r13_w) &&
                    ...
                    pass_reported <= 1'b1;
                    $display("\n*** MULE2N TEST PASSED! ***");
                    $display("Cycle %0d reached 0x%08h. MULE2N x12 = %0d, MUL x13 = %0d, progress_before_writeback = %0d, pipe1_issue_seen = %0d, collision_rd = x%0d",
