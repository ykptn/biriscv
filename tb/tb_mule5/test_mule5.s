###############################################################################
# MULE5 Instruction Test Program
...
.align 4
main:
    # Case 1: aligned slot0/slot1 pair, forcing MULE5 onto pipe1
    li   x10, 7
    li   x11, 9
    mul  x13, x10, x11
    .align 3
    addi x14, x0, 5
    .insn r 0x0B, 0x0, 0x0B, x12, x10, x11
    nop
    nop
    nop
    nop
    ...
    # Case 7: upper-half-heavy operand
    lui  x10, 0x12340
    li   x11, 3
    mul  x13, x10, x11
    .insn r 0x0B, 0x0, 0x0B, x12, x10, x11
    ...
    # Case 8: sparse-vs-dense operand pair
    li   x10, 0x10001
    li   x11, -1
    mul  x13, x10, x11
    .insn r 0x0B, 0x0, 0x0B, x12, x10, x11
    ...
    # Case 11: all five folded chunks active
    li   x10, 0x102040ff
    li   x11, 3
    mul  x13, x10, x11
    .insn r 0x0B, 0x0, 0x0B, x12, x10, x11
